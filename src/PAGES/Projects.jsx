    ...
    <>
      <section className="flex flex-col gap-10 lg:gap-28 pb-20    p-6 lg:p-10 w-full ">
        <main className="max-w-[1000px] mx-auto flex flex-col items-center gap-5 ">
          ...
          <p className="font-medium text-lg lg:text-xl text-main">
          ...
          <button className="p-2 bg-main text-white flex items-center gap-2 px-4">
            <BsArrow90DegDown />
        ...
        <div className="flex items-center gap-3 mx-auto flex-col lg:flex-row">
          ...
          <button className="p-2 bg-main w-max text-white outline-none flex items-center gap-2 px-4">
            <FaRegPaperPlane />
